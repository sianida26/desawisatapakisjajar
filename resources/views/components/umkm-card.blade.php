<button class="w-full flex flex-col shadow-umkm-card border border-ijo focus:ring-ijo focus:ring-offset-2 focus:ring-2 focus:outline-none" onclick="window.location.href='/umkm/detail/{{ $umkm->id }}'">
    {{-- Image --}}
    ...
    <div class="w-full flex flex-col justify-between h-full items-center py-6 px-8">
        ...
        <div class="flex flex-col items-center">
            ...
            @else
                <div disabled class="bg-[#25D366] rounded-md flex items-center gap-2 py-3 px-4 text-white font-medium mt-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#25D366] opacity-70">
                    <i class="bi bi-whatsapp"></i>
                    <span class="font-medium roboto">Hubungi via Whatsapp</span>
                </div>
            @endif
